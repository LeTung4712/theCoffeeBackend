...
class FPTree
{
    ...
    private array $singleItemSupports;
    ...
    public function __construct(array $transactions, float $minSupport, $rootValue, int $rootCount)
    {
        ...
        $this->singleItemSupports = $this->frequent;
    ...
    /**
     * Lấy support của các item đơn lẻ
     * @return array
     */
    public function getSingleItemSupports(): array
    {
        return $this->singleItemSupports;
    }
